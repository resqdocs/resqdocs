...
Format: `resqdocs-protocol` v1. **Datenschutz: nur Struktur (Abschnitte, Felder, Layout) — keine Patientendaten.**

## 1. Doku laden
Öffne und lies diese Seite **vollständig**:
https://ai.resqdocs.app/doc.de.md
...
„Ich kann https://ai.resqdocs.app/doc.de.md nicht öffnen — bitte füge den Doku-Text hier ein."
