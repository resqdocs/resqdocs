...
Format: `{{PROTOCOL_SCHEMA}}` v{{PROTOCOL_VERSION}}. **Data protection: structure only (sections, fields, layout) — no patient data.**
...
"I cannot open {{DOC_URL}} — please paste the doc text here."
